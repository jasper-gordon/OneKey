...
public class GameScrFind : MonoBehaviour
{
    public int count = 0;
            ...
            foreach(KeyValuePair<string, KeyCode> pair in LinkDict)
            {
                if (Input.GetKeyDown(pair.Value))
                {
                    ...
                    if (deathKey == pair.Key)
                    {
                        ...
                        if (count == 1)
                        {
                            Ptext.text = "You   Won   in   " + count.ToString() + "   move";
                        }
                        Ptext.text = "You   Won   in   " + count.ToString() + "   moves";
                    ...
                    else if (!obj.GetComponent<key_script>().ispressed)
                    {
                        ...
                        textobj.GetComponent<Timer>().Reset();
